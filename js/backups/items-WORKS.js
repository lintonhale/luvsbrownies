...
function getfooditemsdata(tx) {
	var sql = "select i.id, i.fooditemname, i.foodgroup, i.foodsubgroup " + 
...
// FOODITEMS TABLE
    ...
    tx.executeSql(sql);
    tx.executeSql("INSERT INTO fooditems (id,fooditemname,foodgroup, foodsubgroup) VALUES (1,'Bagels',1,1)");
    tx.executeSql("INSERT INTO fooditems (id,fooditemname,foodgroup, foodsubgroup) VALUES (2,'Whole Foods','gps','sub')");
    tx.executeSql("INSERT INTO fooditems (id,fooditemname,foodgroup, foodsubgroup) VALUES (3,'Bread French Sourdough',1,1)");
}